...
public abstract class Shader {
    ...
    public void loadBooleanUniform(int location, boolean value) {
		 float toLoad = 0;
    ...
    protected void loadMatrixUniform(int location, Matrix4f projectionMatrix) {
    	FloatBuffer buffer = BufferUtils.createFloatBuffer(16);
    	
    	for (int i = 0; i < 4; i++) {
    		for (int j = 0; j < 4; j++) {
    			buffer.put(projectionMatrix.get(i, j));
    		}
    	}
